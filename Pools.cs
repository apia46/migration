...
{
    #nullable disable
    readonly Vector2 IntendedBgPosition = new(0,ProceduralGenerator.START_POOLS_TRANSITION*ProceduralGenerator.CONVERTED_CHUNK_SIZE*World.CONVERTED_TILE_SIZE);
    TextureRect Bg;
    ...
    public override void _Process(double delta)
    {
        ...
        Vector2 newBgPosition = IntendedBgPosition+(World.Camera.Position-IntendedBgPosition+new Vector2(0,128)) * 0.3f;
